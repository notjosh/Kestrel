  ...
  module Actions
    ...
    class SparkleAddUpdateAction < Action
      ...
      def self.run(params)
        ...
        enclosure.attributes['sparkle:dsaSignature'] = params[:dsa_signature] if params[:dsa_signature]
      ...
      def self.available_options
        [
          ...
          FastlaneCore::ConfigItem.new(key: :dsa_signature,
                                       env_name: 'FL_SPARKLE_ADD_UPDATE_DSA_SIGNATURE',
                                       description: "Update's DSA signature",
                                       optional: true),
